...
`src/test/java/com/example/springboot/StatisticsControllerTest.java`) shows:

====
[source,java]
----
include::complete/src/test/java/com/example/springboot/StatisticsControllerTest.java[]
----
====
...
`src/test/java/com/example/springboot/StatisticsControllerIT.java`):

====
[source,java]
----
include::complete/src/test/java/com/example/springboot/StatisticsControllerIT.java[]
----
====
